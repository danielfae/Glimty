...
const UI = {
  nb: {
    ...
    shop_count: '{count} gaver',
    shop_count_one: '1 gave',
    sort_label: 'Sorter',
    sort_featured: 'Anbefalt',
    sort_price_asc: 'Pris lav–høy',
    sort_price_desc: 'Pris høy–lav',
    shop_help_title: 'Usikker på hva du skal velge?',
    shop_help_body: 'Beskriv personen, så plukker Glimty tre gaver fra lageret.',
    crumbs_label: 'Brødsmulesti',
    filters_label: 'Kategorier',
    why_title: 'Hvorfor Glimty velger den',
    details_title: 'Detaljer',
    detail_brand: 'Merke',
    detail_sku: 'Varenummer',
    detail_category: 'Kategori',
    detail_source: 'Kilde',
    colors_title: 'Farger',
    ask_short: 'Spør Glimty',
    home_hero_shop: 'Se butikken',
  ...
  en: {
    ...
    sku_line: '{brand} · SKU {sku}',
    shop_count: '{count} gifts',
    shop_count_one: '1 gift',
    sort_label: 'Sort',
    sort_featured: 'Featured',
    sort_price_asc: 'Price low–high',
    sort_price_desc: 'Price high–low',
    shop_help_title: 'Not sure what to pick?',
    shop_help_body: 'Describe the person and Glimty picks three gifts from the shelf.',
    crumbs_label: 'Breadcrumb',
    filters_label: 'Categories',
    why_title: 'Why Glimty picks it',
    details_title: 'Details',
    detail_brand: 'Brand',
    detail_sku: 'Item number',
    detail_category: 'Category',
    detail_source: 'Source',
    colors_title: 'Colors',
    ask_short: 'Ask Glimty',
    home_hero_shop: 'Browse the shop',
