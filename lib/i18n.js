...
const UI = {
  nb: {
    ...
    search_label: 'Søk i butikken',
    search_placeholder: 'Søk etter flaske, sekk, Georg Jensen …',
    search_submit: 'Søk',
    search_results: '{count} treff for «{q}»',
    search_none_title: 'Ingen gaver passer «{q}»',
    search_none_body: 'Prøv et annet ord, eller beskriv personen, så finner Glimty noe som passer.',
    search_clear: 'Nullstill filtre',
    filter_none_title: 'Ingen gaver i dette utvalget',
    budget_label: 'Budsjett',
    not_found_popular: 'Eller begynn her',
    see_all: 'Se alle {count}',
    also_like: 'Du vil kanskje også like',
    recent_title: 'Sist sett',
    skip_link: 'Hopp til innholdet',
    nudge_close: 'Lukk',
    footer_shop: 'Butikk',
    footer_help: 'Hjelp',
  ...
  en: {
    ...
    search_placeholder: 'Search for bottle, backpack, Georg Jensen …',
    search_submit: 'Search',
    search_results: '{count} results for “{q}”',
    search_none_title: 'No gifts match “{q}”',
    search_none_body: 'Try another word, or describe the person and Glimty will find something that fits.',
    search_clear: 'Clear filters',
    filter_none_title: 'No gifts in this selection',
    budget_label: 'Budget',
    not_found_popular: 'Or start here',
