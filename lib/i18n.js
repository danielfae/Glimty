...
const UI = {
  nb: {
    ...
    nav_private: 'Privat',
    nav_business: 'Bedrift',
    nav_audience_label: 'Hvem handler du for',
    nav_menu: 'Meny',
    footer_left: 'Glimty — gaver for privat og bedrift.',
    footer_right: 'Bilder og produkttekst fra you.no. Lageret holdes av Glimty.',
    footer_home_left: 'Glimty — personlige gaver og firmagaver.',
    footer_home_right: 'Snakk på nettet. Vi blir med deg til gaven er valgt.',
    footer_link_private: 'Private gaver',
    footer_link_business: 'Firmagaver',
    footer_link_shop: 'Katalog',
    footer_link_faq: 'FAQ',
    ...
    home_cta_business: 'Firmagaver',

    business_title: 'Firmagaver — Glimty',
    business_description: 'Firmagaver, kundegaver og teamgaver fra samme katalog — med en assistent som hjelper deg å velge.',
    business_eyebrow: 'For bedrifter',
    business_lede: 'Merch og gaver til merkevaren din',
    business_intro: 'Samme katalog som private gaver — flasker, vesker, hjem og ute. Fortell assistenten om teamet, kunden eller arrangementet, så får du forslag og vei videre.',
    business_cta_talk: 'Få firmagaver-forslag',
    business_cta_shop: 'Bla i katalogen',
    business_benefit1_title: 'Veiledet valg',
    business_benefit1_body: 'Beskriv mottaker, antall og budsjett. Assistenten holder tråden.',
    business_benefit2_title: 'Katalog klar for branding',
    business_benefit2_body: 'Produkter fra You Brands — egnet til firmagaver, giveaways og swag.',
    business_benefit3_title: 'Én vei for privat og bedrift',
    business_benefit3_body: 'Bytt mellom Privat og Bedrift i menyen. Samme lager, to vinkler.',
    business_how_title: 'Slik funker firmagaver',
    business_how_intro: 'Assistent først, katalog når du vil bla, og en tydelig bedriftsvinkel i navigasjonen.',

    shop_title: 'Katalog — Glimty',
    shop_title_cat: '{label} — Glimty katalog',
    shop_eyebrow: 'Lager',
    shop_heading: 'Katalogen',
  ...
  en: {
    ...
    nav_private: 'Personal',
    nav_business: 'Business',
    nav_audience_label: 'Who are you shopping for',
    nav_menu: 'Menu',
    footer_left: 'Glimty — gifts for people and for brands.',
    footer_right: 'Photos and product copy sourced from you.no. Inventory is held by Glimty.',
    footer_home_left: 'Glimty — personal gifts and corporate merch.',
    footer_home_right: 'Talk on the web. We stay with you until the gift is chosen.',
    footer_link_private: 'Personal gifts',
    footer_link_business: 'Business gifts',
    footer_link_shop: 'Catalog',
    footer_link_faq: 'FAQ',
    ...
    home_cta_business: 'Business gifts',

    business_title: 'Business gifts — Glimty',
    business_description: 'Corporate gifts, client gifts, and team merch from the same catalog — with an assistant that helps you choose.',
    business_eyebrow: 'For businesses',
    business_lede: 'Merch and gifts for your brand',
    business_intro: 'The same catalog as personal gifts — bottles, bags, home, and outdoors. Tell the assistant about the team, client, or event, and get options with a clear next step.',
    business_cta_talk: 'Get business gift ideas',
    business_cta_shop: 'Browse the catalog',
    business_benefit1_title: 'Guided advice',
    business_benefit1_body: 'Describe the recipient, quantity, and budget. The assistant keeps the thread.',
    business_benefit2_title: 'Catalog ready for branding',
    business_benefit2_body: 'You Brands products suited to corporate gifts, giveaways, and swag.',
    business_benefit3_title: 'One path for B2C and B2B',
    business_benefit3_body: 'Switch between Personal and Business in the nav. Same inventory, two angles.',
    business_how_title: 'How business gifts work',
    business_how_intro: 'Assistant first, catalog when you want to browse, and a clear business angle in the navigation.',

    shop_title: 'Catalog — Glimty',
    shop_title_cat: '{label} — Glimty catalog',
    shop_eyebrow: 'Inventory',
    shop_heading: 'The catalog',
...
function uiPack(locale) {
  ...
  const keys = [
    ...
    'nav_start_over', 'chat_error', 'lang_label', 'home_cat_gifts',
