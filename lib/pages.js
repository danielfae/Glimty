...
function productPage(id, locale) {
  ...
  return layout({
    ...
    <article class="product">
      ...
      <div class="product-grid">
        ...
        <aside class="buybox">
          ...
          <a class="btn btn-primary btn-block" href="/assistant?lang=${locale}">${escapeHtml(t('ask_about'))}</a>
    ...
    <div class="buybar">
      ...
      <a class="btn btn-primary" href="/assistant?lang=${locale}">${escapeHtml(t('ask_short'))}</a>
    </div>`
  });
}
